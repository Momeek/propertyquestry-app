...
import { Search, Send, ArrowLeft, MoreVertical, User } from "lucide-react";
...
export default function MobileMessagesInterface() {
  ...
  return (
    <div className="md:hidden border rounded-lg bg-white overflow-hidden h-[calc(100vh-220px)] flex flex-col">
      {!activeConversation ? (
